class Memory {
    ...
    //which you can safely modify, returning a pointer to the 1st box 
    ...
    // to pointer (for example, copy(10, 0, 3) would copy the values at boxes
    // 0, 1 and 2 to the boxes at 10, 11 and 12 respectively)
